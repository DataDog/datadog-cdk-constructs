...
| `redirectHandler` | `redirect_handler` | When set to `false`, skip redirecting handler to Datadog's Lambda Libraries'. Useful when only instrumenting with Datadog Lambda Extension. Defaults to `true`. |
