...
1. Invoke your Step Function and look for them in [Datadog Serverless Monitoring](https://app.datadoghq.com/serverless/aws/step-functions&entity_view=step_functions).
